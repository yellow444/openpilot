...
class CarState(CarStateBase):
  ...
  def update(self, pt_cp, cam_cp, ext_cp, trans_type):
    ...
    self.parking_brake_set = bool(pt_cp.vl["Kombi_01"]["KBI_Handbremse"])  # FIXME: need to include an EPB check as well
    ...
    self.acc_faulted = pt_cp.vl["TSK_06"]["TSK_Status"] in (6, 7)
  ...
  def update_pq(self, pt_cp, cam_cp, ext_cp, trans_type):
    ...
    self.parking_brake_set = bool(pt_cp.vl["Kombi_1"]["Bremsinfo"])
